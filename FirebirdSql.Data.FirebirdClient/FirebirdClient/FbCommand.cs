...
namespace FirebirdSql.Data.FirebirdClient
{
	public sealed class FbCommand : DbCommand, ICloneable
	{
		...
		{
            if (this.HasImplicitTransaction && this.transaction != null && this.transaction.Transaction != null && this.Connection.InnerConnection != null) //nsg 3 12 2015 + && this.Connection.InnerConnection != null
			{
